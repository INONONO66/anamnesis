...
test("dynamics replay: real Node/UDS receipt Hits, restart, corruption detection and rebuild", async () => {
  ...
  try {
    ...
    console.log(JSON.stringify({ checkpoint: "dynamics-replay", controls, expectedCache, immutable_preserved: true, dynamics_assertions: ["receipt_adoption", "outcome_utility", "restart", "equal_count_corruption", "rebuild", "numeric_version", "event_ids"] }));
